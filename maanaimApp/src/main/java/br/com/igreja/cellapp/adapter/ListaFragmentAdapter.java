...
public class ListaFragmentAdapter extends BaseAdapter{
	...
	private int[] icones = {R.drawable.mapp_ic_igreja, R.drawable.mapp_ic_anotacao, R.drawable.mapp_ic_familia, R.drawable.reunioes,
			R.drawable.ponteiro, R.drawable.mapp_ic_ok, R.drawable.ic_launcher, R.drawable.sair };
