...
public class Relatorios_ViewBinding implements Unbinder {
  private Relatorios target;

  @UiThread
  public Relatorios_ViewBinding(Relatorios target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public Relatorios_ViewBinding(Relatorios target, View source) {
    this.target = target;
